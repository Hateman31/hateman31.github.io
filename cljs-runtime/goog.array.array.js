goog.loadModule(function(exports) {
  ...
  function bucket(array, sorter, opt_obj) {
    ...
    for (var i = 0; i < array.length; i++) {
      ...
      if (key !== undefined) {
        var bucket$8 = buckets[key] || (buckets[key] = []);
        bucket$8.push(value);
      }
    }
    return buckets;
  ...
  function bucketToMap(array, sorter) {
    ...
    for (var i = 0; i < array.length; i++) {
      ...
      if (key !== undefined) {
        var bucket$9 = buckets.get(key);
        if (!bucket$9) {
          bucket$9 = [];
          buckets.set(key, bucket$9);
        }
        bucket$9.push(value);
      }
    }
  ...
  function range(startOrEnd, opt_end, opt_step) {
    ...
    if (step > 0) {
      ...
      for (var i$10 = start; i$10 > end; i$10 += step) {
        array.push(i$10);
      }
    }
    return array;
  ...
  function zip(var_args) {
    ...
    for (var i$11 = 0; i$11 < minLen; i$11++) {
      var value = [];
      for (var j = 0; j < arguments.length; j++) {
        value.push(arguments[j][i$11]);
      }
      result.push(value);
    }
    return result;
