...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_11359 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_11359(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_11362 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_11362(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_11367 = (function (reader,ch){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_11367(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_11368 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_11368(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_11370 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_11370(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_11371 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_11371(reader);
}
});
...
var G__11407 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__11408 = s.append(c);
c = G__11407;
s = G__11408;
continue;
}
