...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_11700 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_11700(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_11705 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_11705(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_11712 = (function (reader,ch){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_11712(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_11721 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_11721(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_11733 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_11733(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_11741 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_11741(reader);
}
});
...
var G__11950 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__11951 = s.append(c);
c = G__11950;
s = G__11951;
continue;
}
