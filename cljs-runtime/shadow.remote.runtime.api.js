...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_18835 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_18835(runtime,msg);
}
});

var shadow$remote$runtime$api$IRuntime$add_extension$dyn_18843 = (function (runtime,key,spec){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_18843(runtime,key,spec);
}
});

var shadow$remote$runtime$api$IRuntime$del_extension$dyn_18851 = (function (runtime,key){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$del_extension$dyn_18851(runtime,key);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_18852 = (function (thing,opts){
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_18852(thing,opts);
}
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_18853 = (function (runtime,input,callback){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_18853(runtime,input,callback);
}
});
...
var shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_18854 = (function (runtime,code){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_18854(runtime,code);
}
});


shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__18815,callback){
var map__18827 = p__18815;
var map__18827__$1 = cljs.core.__destructure_map(map__18827);
var input = map__18827__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__18827__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__18827__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
