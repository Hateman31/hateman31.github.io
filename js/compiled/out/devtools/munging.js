...
var o22438 = temp__5718__auto__;
var temp__5718__auto____$1 = (o22438["core"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o22439 = temp__5718__auto____$1;
return (o22439["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__21550__auto__ = f;
return (o__21550__auto__["toString"]).call(o__21550__auto__);
} else {
return "";
}
}catch (e22440){var _ = e22440;
return "";
}});
...
try{var o__21550__auto___22442 = t;
(o__21550__auto___22442["cljs$lang$ctorPrWriter"]).call(o__21550__auto___22442,t,writer);
}catch (e22441){var __22443 = e22441;
}
...
var char_code = (function (){var o__21550__auto__ = (new String(char$));
return (o__21550__auto__["charCodeAt"]).call(o__21550__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__21550__auto__ = String;
return (o__21550__auto__["fromCharCode"]).call(o__21550__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__22444 = num_code;
switch (G__22444) {
case (1):
return (185);
...
var o__21550__auto__ = String;
return (o__21550__auto__["fromCharCode"]).call(o__21550__auto__,superscript_code);
});
/**
...
}catch (e22446){var _e__21557__auto__ = e22446;
return false;
}})())){
...
var vec__22447 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__22447,(0),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var o22450 = temp__5718__auto__;
var temp__5718__auto____$1 = (o22450["dependencies_"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o22451 = temp__5718__auto____$1;
return (o22451["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4730__auto___22458 = arguments.length;
var i__4731__auto___22459 = (0);
while(true){
if((i__4731__auto___22459 < len__4730__auto___22458)){
args__4736__auto__.push((arguments[i__4731__auto___22459]));

var G__22460 = (i__4731__auto___22459 + (1));
i__4731__auto___22459 = G__22460;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__22454){
var vec__22455 = p__22454;
var ns_detector = cljs.core.nth.call(null,vec__22455,(0),null);
...
var G__22461 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__22462 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__22461;
remaining_tokens = G__22462;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq22452){
var G__22453 = cljs.core.first.call(null,seq22452);
var seq22452__$1 = cljs.core.next.call(null,seq22452);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__22453,seq22452__$1);
});
...
var vec__22466 = cljs.core.split_with.call(null,(function (p1__22465_SHARP_){
return cljs.core.not_EQ_.call(null,p1__22465_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__22466,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__22466,(1),null);
...
var vec__22472 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__22472,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__22472,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__22475 = cljs.core.rest.call(null,remaining_tokens);
var G__22476 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__22475;
name_tokens = G__22476;
continue;
} else {
...
var vec__22479 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__22479,(0),null);
var arity = cljs.core.nth.call(null,vec__22479,(1),null);
var vec__22482 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__22482,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__22482,(1),null);
var vec__22485 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__22485,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__22485,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__22485,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__22485,(3),null);
...
var vec__22491 = result;
var munged_ns = cljs.core.nth.call(null,vec__22491,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__22491,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__22491,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__22491,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__22491,(4),null);
var arity = cljs.core.nth.call(null,vec__22491,(5),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var vec__22495 = temp__5718__auto__;
var munged_name = cljs.core.nth.call(null,vec__22495,(0),null);
var args = cljs.core.nth.call(null,vec__22495,(1),null);
var vec__22498 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__22498,(0),null);
var name = cljs.core.nth.call(null,vec__22498,(1),null);
...
var G__22501 = (arity + (1));
var G__22502 = (function (){var temp__5718__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5718__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__22503){
var vec__22504 = p__22503;
var arity = cljs.core.nth.call(null,vec__22504,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__22504,(1),null);
...
return (function (p1__22507_SHARP_){
return cljs.core.get.call(null,arities,p1__22507_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__22508_SHARP_);
...
var args__4736__auto__ = [];
var len__4730__auto___22515 = arguments.length;
var i__4731__auto___22516 = (0);
while(true){
if((i__4731__auto___22516 < len__4730__auto___22515)){
args__4736__auto__.push((arguments[i__4731__auto___22516]));

var G__22517 = (i__4731__auto___22516 + (1));
i__4731__auto___22516 = G__22517;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__22511){
var vec__22512 = p__22511;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__22512,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq22509){
var G__22510 = cljs.core.first.call(null,seq22509);
var seq22509__$1 = cljs.core.next.call(null,seq22509);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__22510,seq22509__$1);
});
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__22520__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__22520__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__22520__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__22520__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__22521 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__22521,(0),null);
var fn_name = cljs.core.nth.call(null,vec__22521,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__22521,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__22521,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__22521,(4),null);
var arity = cljs.core.nth.call(null,vec__22521,(5),null);
...
var o__21550__auto__ = f;
return (o__21550__auto__["getBasis"]).call(o__21550__auto__);
});
/**
...
}catch (e22525){var _e__21557__auto__ = e22525;
...
var G__22526 = (obj[cljs.core.first.call(null,path)]);
var G__22527 = cljs.core.rest.call(null,path);
obj = G__22526;
path = G__22527;
continue;
} else {
...
return (function (accum,p__22528){
var vec__22529 = p__22528;
var bit = cljs.core.nth.call(null,vec__22529,(0),null);
var protocol = cljs.core.nth.call(null,vec__22529,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__22532){
var vec__22533 = p__22532;
var ns = cljs.core.nth.call(null,vec__22533,(0),null);
var name = cljs.core.nth.call(null,vec__22533,(1),null);
var selector = cljs.core.nth.call(null,vec__22533,(2),null);
...
return (function (p__22537){
var vec__22538 = p__22537;
var munged_name = cljs.core.nth.call(null,vec__22538,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__22538,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__22538,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__22536_SHARP_){
return (obj[cljs.core.first.call(null,p1__22536_SHARP_)]);
});})(name,sorted_matches,vec__22538,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1652342998985
