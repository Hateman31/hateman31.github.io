...
return (new CustomEvent(event_name,(function (){var obj21495 = ({"detail":data});
return obj21495;
})()));
} else {
...
var f = (function (){var pred__21502 = cljs.core._EQ_;
var expr__21503 = ((figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__21502.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__21503))){
return ((function (pred__21502,expr__21503){
return (function (p1__21496_SHARP_){
return console.warn(p1__21496_SHARP_);
});
;})(pred__21502,expr__21503))
} else {
if(cljs.core.truth_(pred__21502.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__21503))){
return ((function (pred__21502,expr__21503){
return (function (p1__21497_SHARP_){
return console.debug(p1__21497_SHARP_);
});
;})(pred__21502,expr__21503))
} else {
if(cljs.core.truth_(pred__21502.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__21503))){
return ((function (pred__21502,expr__21503){
return (function (p1__21498_SHARP_){
return console.error(p1__21498_SHARP_);
});
;})(pred__21502,expr__21503))
} else {
return ((function (pred__21502,expr__21503){
return (function (p1__21499_SHARP_){
return console.log(p1__21499_SHARP_);
});
;})(pred__21502,expr__21503))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__21506){
var map__21507 = p__21506;
var map__21507__$1 = (((((!((map__21507 == null))))?(((((map__21507.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__21507.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__21507):map__21507);
var opts = map__21507__$1;
var eval_fn = cljs.core.get.call(null,map__21507__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__21509_SHARP_);
});})(new_def))
);
...
return (function (p__21510){
var vec__21511 = p__21510;
var ky = cljs.core.nth.call(null,vec__21511,(0),null);
var v = cljs.core.nth.call(null,vec__21511,(1),null);
...
}catch (e21516){if((e21516 instanceof Error)){
var e = e21516;
return not_found;
} else {
throw e21516;
...
//# sourceMappingURL=utils.js.map?rel=1652342998422
